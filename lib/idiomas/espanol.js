...
const smsAvisoRG = () => { return `╰⊱✅⊱ *NƏTİCƏ* ⊱✅⊱╮\n\n` }
const smsAvisoAG = () => { return `╰⊱⚠️⊱ *XƏBƏRDARLIQ* ⊱⚠️⊱╮\n\n` }
const smsAvisoIIG = () => { return `╰⊱❕⊱ *MƏLUMAT* ⊱❕⊱╮\n\n` }
const smsAvisoFG = () => { return `╰⊱❌⊱ *XƏTA* ⊱❌⊱╮\n\n` }
const smsAvisoMG = () => { return `╰⊱❗️⊱ *SUİ-istifadə* ⊱❗️⊱╮\n\n` }
const smsAvisoEEG = () => { return `╰⊱📩⊱ *HESABAT* ⊱📩⊱╮\n\n` }
const smsAvisoEG = () => { return `╰⊱💚⊱ *UĞURLU* ⊱💚⊱╮\n\n` }
...
const smsLista2 = () => { return `💖 YARADAN 💖`}
const smsLista3 = () => { return `🎁 ianə etmək : DƏSTƏK 🎁`}
